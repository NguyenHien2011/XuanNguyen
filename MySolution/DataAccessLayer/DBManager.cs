...
namespace DataAccessLayer
{
    ...
    public class DBManager : IDBManager
    {
        ...
        public DBManager() { }
        public DBManager(DataProvider providerType, string connecionString)
        {
            this.providerType = providerType;
            this.strConnection = connecionString;
        }
        public DBManager(DataProvider providerType, IDbConnection dbConnection, string connectionString)
        {
            this.providerType = providerType;
